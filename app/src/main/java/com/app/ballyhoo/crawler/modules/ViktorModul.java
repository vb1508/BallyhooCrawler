...
/**
 * Created by viktor on 11/22/2017.
 */

public class ViktorModul extends AbstractModule {
    ...
    public ViktorModul(Context context) {
        super(context, "ViktorModul", LocalDate.now(), LocalDate.now().plusDays(7));
    }
